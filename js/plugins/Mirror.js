 ...
 *
 ...
 Edit by SigmaSuccour: this version of the plugin ONLY shows the Mirror Reflection. (The water reflection has been edited out.)
...
(function(alias){
	Sprite_Character.prototype.updateHalfBodySprites = function() {
		...
		if(this._southReflect !== null){
			...
			this._southReflect.x = rx * 0 - (pw - 0) / 2 - dx;
			this._southReflect.y = ry * 0 + ph + 0       - dy;
